...
def schedule_edf(data):
    ...
    while current_time < data.iat[0,1]:
        ...
        if sorted_deadline.iat[0,2] + current_time > data.iat[0,1]:
            partial_execution = data.iat[0,1] - current_time
            output += f"{current_time} {sorted_deadline.iat[0,0]} 1188 {partial_execution} {str(partial_execution * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
            ...
            if sorted_period.iat[0,7] < current_time:
                if sorted_period.iat[0,8] > partial_execution:
                    output += f"{current_time} {sorted_period.iat[0,0]} 1188 {partial_execution} {str(partial_execution * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                    total_energy += (partial_execution * (sorted_deadline.iat[0,9])/1000)
                    current_time += partial_execution
                    ...
                    output += f"{current_time} {sorted_period.iat[0,0]} 1188 {sorted_period.iat[0,8]} {str(sorted_period.iat[0,8] * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                    ...
                    output += f"{current_time} {sorted_period.iat[0,0]} 1188 {sorted_period.iat[0,2]} {str(sorted_period.iat[0,2] * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
            ...
            if(sorted_deadline.iat[0,8] > 0):
                output += f"{current_time}, {sorted_deadline.iat[0,0]} 1188 {sorted_deadline.iat[0,8]} {str((sorted_deadline.iat[0,8]) * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                ...
                output += f"{current_time} {sorted_deadline.iat[0,0]} 1188 {sorted_deadline.iat[0,2]} {str(sorted_deadline.iat[0,2] * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
    ...
    while current_time < data.iat[0, 1]:
        ...
        if active_tasks.empty:
            ...
            if active_tasks.iat[0,2] + current_time > data.iat[0,1]:
                partial_execution = data.iat[0,1] - current_time
                output += f"{current_time} {active_tasks.iat[0,0]} 1188 {partial_execution} {str(partial_execution * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                total_energy += (partial_execution * (sorted_deadline.iat[0,9])/1000)
                current_time += partial_execution
                ...
                output += f"{current_time} {active_tasks.iat[0,0]} 1188 {remaining_time} {str(remaining_time * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                ...
                if(active_tasks.iat[0,8] > 0):
                    output += f"{current_time}, {active_tasks.iat[0,0]} 1188 {active_tasks.iat[0,8]} {str((active_tasks.iat[0,8]) * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
                    ...
                    output += f"{current_time} {active_tasks.iat[0,0]} 1188 {active_tasks.iat[0,2]} {str(active_tasks.iat[0,2] * (sorted_deadline.iat[0,9])/1000)+'J'}\n"
...
def max_efficiency(data):
    ...
    subtracted_values.drop(subtracted_values.columns[2:9], axis=1, inplace=True)
    ...
    data_wcet_change.drop(data_wcet_change.columns[2:9], axis=1, inplace=True)
    ...
    subtracted_values['max_value'] = subtracted_values.iloc[:, 3:6].max(axis=1)
